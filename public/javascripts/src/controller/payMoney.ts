...
function payMoney($scope:any,$rootScope:IRootScope.rootScope,ToolService:Tool,AjaxService:Ajax){
    $scope.showPay = false;
    $scope.money = {
        dealMoney:null,
        balance:null,
    ...
    //申请提现
    $scope.getMoney = (flag:any,$event:ag.IAngularEvent)=>{
