...
function register($scope:any,$rootScope:IRootScope.rootScope,$location:ag.ILocationService,$interval:ag.IIntervalService,AjaxService:Ajax,ToolService:Tool){
    $scope.phone=""; //手机号码
    $scope.password=""; //密码
