...
function myFollow($scope:any,$rootScope:IRootScope.rootScope,$location:ag.ILocationService,ToolService:Tool,AjaxService:Ajax){
    //导航条变量
    $scope.params = {
        doctor:false,
        user:true,
    ...
    // 关注按钮处理函数
    $scope.switchFollow = (id:any,flag:any)=>{
    ...
    // 取消关注用户
    let cacelFollow = (id:any,flag:any)=>{
        AjaxService.post({
