...
function findpass($scope:any,$rootScope:IRootScope.rootScope,$location:ag.ILocationService,$interval:ag.IIntervalService,ToolService:Tool,AjaxService:Ajax){
    $scope.phone = ""; //手机号码
    $scope.code = ""; //验证码
    $scope.pwd = ""; //密码
