...
function order($scope:any,$rootScope:IRootScope.rootScope,$location:ag.ILocationService,AjaxService:Ajax,ToolService:Tool){
    $scope.orders;
    $scope.cancelOrderId;
    $scope.noOrder = false;
    $scope.status = "";
    ...
    let merge = (orders:any)=>{
        orders.forEach((item:any,index:any,array:any)=>{
            item.toPay = false;
            item.payed = false;
            item.canceled = false;
            item.tocancel = false;
