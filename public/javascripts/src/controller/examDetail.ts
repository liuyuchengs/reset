...
function examDetail($scope:any,$rootScope:IRootScope.rootScope,$location:ag.ILocationService,ToolService:Tool,AjaxService:Ajax){
    ...
    // 切换导航条
    $scope.switch = (index:number,obj:any[])=>{
