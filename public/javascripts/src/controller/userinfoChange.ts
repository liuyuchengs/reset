...
function userChange($scope:any,$rootScope:IRootScope.rootScope,$location:ag.ILocationService,$timeout:ag.ITimeoutService,$http:ag.IHttpService,AjaxService:Ajax,ToolService:Tool){
    $scope.title;
    $scope.tip;
    $scope.val="";
    $scope.hasImg = false;
