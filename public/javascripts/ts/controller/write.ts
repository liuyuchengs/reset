...
function write($scope:any,$rootScope:IRootScope.rootScope,$http:ag.IHttpService,ToolService:Tool,AjaxService:Ajax){
    ...
    $scope.loadOrder = ()=>{
        AjaxService.post({
            ...
            if(data.code===0){
                var result = data.data.filter((item:any)=>{
